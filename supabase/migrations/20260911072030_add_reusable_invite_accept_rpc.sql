create function private.accept_reusable_chronicle_invite_impl(p_code uuid)
returns uuid
language plpgsql
security definer
set search_path = ''
...
create function public.accept_reusable_chronicle_invite(p_code uuid)
returns uuid
language sql
security invoker
set search_path = ''
...
revoke all on function private.accept_reusable_chronicle_invite_impl(uuid) from public, anon;
grant execute on function private.accept_reusable_chronicle_invite_impl(uuid) to authenticated;
revoke all on function public.accept_reusable_chronicle_invite(uuid) from public, anon;
grant execute on function public.accept_reusable_chronicle_invite(uuid) to authenticated;
